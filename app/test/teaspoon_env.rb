...
Teaspoon.configure do |config|
  ...
  config.suite do |suite|
    ...
    suite.no_coverage = [%r{/lib/ruby/gems/}, %r{/locales/}, %r{/templates/}, %r{/javascripts/assets./}, %r{/vendor/assets/}, %r{/support/}, %r{/(.+)_helper.}]
  ...
  config.suite :jshint do |suite|
    suite.matcher = nil
    suite.helper = "jshint_suite"
  end
